...
const translations = {
    ar: {
        ...
        ai_safety_disclaimer: "تنبيه هام: أنا نظام ذكي للمساعدة والتوجيه فقط. لا أقوم بالتشخيص النهائي ولا أصف الأدوية. يرجى مراجعة الطبيب المختص لأي حالة طبية.",
    ...
    en: {
        ...
        ai_safety_disclaimer: "IMPORTANT: I am an AI guidance system only. I do NOT diagnose or prescribe. Please consult a professional doctor.",
